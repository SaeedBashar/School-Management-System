<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminSignUp.aspx.vb" Inherits="WORK.AdminSignUp" %>
...
<head runat="server">
    ...
    <title>EasyMan | Administrator Sign Up</title>
</head>
                ...
                <div class="container">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 offset-md-4">
                            <button type="button" runat="server" id="submitbtna" onserverclick="submitbtn_Click" class="btn btn-primary btn-block">Sign Up</button>
