<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TutorProfileView.aspx.vb" Inherits="WORK.TutorProfileView" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col">
                                ...
                                <label>Tutor Id :</label><asp:TextBox CssClass="form-control" runat="server" id="stdidtxt" type="text" Enabled="False"></asp:TextBox>
                                <label>Gender :</label><asp:TextBox CssClass="form-control" runat="server" id="gnametxt" type="text" Enabled="False"></asp:TextBox>
                                <label>Tutor Contact:</label><asp:TextBox CssClass="form-control" runat="server" id="gcontacttxt" type="text" Enabled="False"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
