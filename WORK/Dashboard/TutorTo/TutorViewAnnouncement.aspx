<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TutorViewAnnouncement.aspx.vb" Inherits="WORK.TutorViewAnnouncement" %>
        ...
        <div class="container">
            ...
            <div class="row m-auto pb-5" style="border-bottom: 1px solid #808080;">
                <div class="col">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover  table-borderless m-auto"  style="border-radius:10px;" Width="100%" AllowPaging="True"  AutoGenerateColumns="False" BorderWidth="0px" CellPadding="2" DataSourceID="SqlDataSource1">
                        <Columns>
                            <asp:BoundField DataField="title" HeaderText="Headline" SortExpression="title" />
