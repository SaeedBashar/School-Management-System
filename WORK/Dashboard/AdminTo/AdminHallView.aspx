            ...
            <div class="col">
                <div class="card text-center">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div class="collapse navbar-collapse mySubNav" id="navbarSupportedContent">
                                ...
                                <div class="form-inline my-2 my-lg-0">
                                    <input class="form-control mr-sm-2" runat="server" id="id_input" type="search" placeholder="Enter a house Id to delete" aria-label="Search"/>
                    ...
                    <div class="card-body" style="height:auto;">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="3" CssClass="table table-hover table-borderless" DataKeyNames="House_id" DataSourceID="SqlDataSource1">
                            <Columns>
                                <asp:BoundField DataField="House_id" HeaderText="House Id" InsertVisible="False" ReadOnly="True" SortExpression="House_id" />
                                <asp:BoundField DataField="House_name" HeaderText="House Name" SortExpression="House_name" />
                                <asp:BoundField DataField="House_master_id" HeaderText="House Master Id " SortExpression="House_master_id" />
                                <asp:CommandField SelectText="Details" ShowSelectButton="True" />
                            </Columns>
                            <HeaderStyle BackColor="#3399FF" ForeColor="White" Width="80%" Font-Bold="True" />
                        </asp:GridView>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=DESKTOP-VPRF4HJ\SQLEXPRESS;Initial Catalog=SchoolManagement;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Houses]"></asp:SqlDataSource>
                    </div>
