                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div class="collapse navbar-collapse mySubNav" id="navbarSupportedContent">
                                ...
                                <div class="form-inline my-2 my-lg-0">
                                    <input runat="server" id="eventinp" class="form-control mr-sm-2" type="search" placeholder="Delete a by title" aria-label="Search"/>
                                    <button runat="server" id="delEvent"  onserverclick="delEvent_ServerClick" class="btn btn-outline-success my-2 my-sm-0" type="button">Delete</button>
                                </div>
                            </div>
                        </nav>
                    </div>
