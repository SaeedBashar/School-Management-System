<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminAddProgramView.aspx.vb" Inherits="WORK.AdminAddProgramView" %>
        ...
        <div class="card-body">
            <form id="form1" runat="server">
                <div class="container">
                    <div class="form-row">
                        <div class="col-12">
                            <label for="fnametxt">Program Name</label>
                            <asp:TextBox runat="server" ID="pnametxt" type="text" CssClass="form-control" placeholder="Course name"></asp:TextBox>
                        </div>
                        
                        <div class="col-12">
                            <label for="tutidtxt">Head of Department Id</label>
                            <asp:TextBox runat="server" ID="tutidtxt" type="text" CssClass="form-control" placeholder="Tutor Id"></asp:TextBox>
                        </div>
                    </div>
