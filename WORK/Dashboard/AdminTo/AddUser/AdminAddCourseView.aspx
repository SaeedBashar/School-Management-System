<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminAddCourseView.aspx.vb" Inherits="WORK.AdminAddCourseView" %>
        ...
        <div class="card-body">
            <form id="form1" runat="server">
                <div class="container">
                    <div class="form-row">
                        <div class="col-12">
                            <label for="fnametxt">Course Name</label>
                            <asp:TextBox runat="server" ID="snametxt" type="text" CssClass="form-control" placeholder="Course name"></asp:TextBox>
                        </div>
                        
                        <div class="col-12">
                            <label for="lnametxt">Tutor Id</label>
