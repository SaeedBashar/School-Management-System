...
Public Class AdminTutorView
    ...
    Private Sub fillGridView()
        ...
        Dim query As String = "select fname, mname, lname, tutor_id from tutors"
        cmd.Connection = con
    ...
    Private Sub GridView1_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        Dim tutorId As Integer = GridView1.DataKeys(e.RowIndex).Value
        Dim cmd As New SqlCommand
        Dim query As String = "delete from tutors where tutor_id='" & tutorId & "'"
    ...
    Protected Sub BtnSearch_ServerClick(sender As Object, e As EventArgs)
        Dim cmd As New SqlCommand
        Dim query As String = "select tutor_id,fname,mname, lname from tutors where fname like '%" & searchtxt.Text & "%'"
        cmd.Connection = con
        cmd.CommandText = query
