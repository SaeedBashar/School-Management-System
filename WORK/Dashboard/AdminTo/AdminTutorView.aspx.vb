...
Public Class AdminTutorView
    ...
    Protected Sub delbtn_ServerClick(sender As Object, e As EventArgs)
        ...
        Dim query As String = "delete from tutors where tutor_id='" & id_input.Value.Trim() & "'"
        ...
        If num > 0 Then
            ClientScript.RegisterClientScriptBlock(Me.GetType(), "Success", "<script type='text/javascript'>alert('Data Deleted Successfully');window.location=AdminTutorView.aspx;</script>")
        End If
        con.Close()
    End Sub
End Class