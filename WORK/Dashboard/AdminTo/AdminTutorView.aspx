<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminTutorView.aspx.vb" Inherits="WORK.AdminTutorView" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
        <div class="container-fluid">
            <a class="navbar-brand" style="color: white;" href="#">EasyMan</a>
                ...
                <div class="card text-center">
                    <div class="card-header">
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <a class="navbar-brand" href="AddUser/AdminAddTutorView.aspx" style="background-color:#2ec42d;padding: 1px 5px;border-radius:4px;">
