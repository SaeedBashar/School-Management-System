...
Public Class AdminCourseView
    ...
    Private Sub fillGridView()
        ...
        Dim query As String = "select sub_id, sub_name, teacher_id from Courses"
        cmd.Connection = con
    ...
    Private Sub GridView1_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim cmd As New SqlCommand
        Dim query As String = "delete from courses where sub_id='" & Id & "'"
    ...
    Protected Sub BtnSearch_ServerClick(sender As Object, e As EventArgs)
        Dim cmd As New SqlCommand
        Dim query As String = "select sub_id, sub_name, teacher_id from courses where sub_name like '%" & searchtxt.Text & "%'"
        cmd.Connection = con
        cmd.CommandText = query
