...
Public Class AdminHallView
    ...
    Private Sub fillGridView()
        ...
        Dim query As String = "select house_id, house_name, house_master_id from houses"
        cmd.Connection = con
    ...
    Private Sub GridView1_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Dim cmd As New SqlCommand
        Dim query As String = "delete from houses where house_id='" & Id & "'"
    ...
    Protected Sub BtnSearch_ServerClick(sender As Object, e As EventArgs)
        Dim cmd As New SqlCommand
        Dim query As String = "select house_id, house_name, house_master_id from houses where house_name like '%" & searchtxt.Text & "%'"
        cmd.Connection = con
        cmd.CommandText = query
