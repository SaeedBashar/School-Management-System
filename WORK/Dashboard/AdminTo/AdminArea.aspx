<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminArea.aspx.vb" Inherits="WORK.AdminArea" %>
                        ...
                        <div class="card-body" >
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-4">
                                    <p id="cuser" runat="server" style="font-size: 30px; font-weight: 100"></p>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col">
                                ...
                                <label>Admin Name :</label><asp:TextBox CssClass="form-control" runat="server" id="unametxt" type="text" Enabled="False"></asp:TextBox>
                                ...
                                <label>Admin Id:</label><asp:TextBox CssClass="form-control" runat="server" id="stdidtxt" type="text" Enabled="False"></asp:TextBox>
                                <label>Gender:</label><asp:TextBox CssClass="form-control" runat="server" id="gnametxt" type="text" Enabled="False"></asp:TextBox>
                                <label>Admin Contact:</label><asp:TextBox CssClass="form-control" runat="server" id="gcontacttxt" type="text" Enabled="False"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer style="background-color: #b0abab;" class="p-4">
                        <div class="container">
                            ...
                            <div class="row">
                               <div class="col-12">
                                   <hr /> 
                                   <p style="font-size: 20px;text-align:center;">You logged In as <a href="#" id="loguname" runat="server" ></a><a href="../../SignIn.aspx">(Log Out)</a></p>
                               </div>
                            </div>
                        </div>        
                    </footer>
