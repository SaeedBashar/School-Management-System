<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminViewStudentView.aspx.vb" Inherits="WORK.AdminViewStudentView" %>
        ...
        <div class="container">
            <div class="row" style="border-bottom:1px solid #808080">
             ...
             <div class="row form-group p-3">
                ...
                <div class="col-6">
                    <asp:TextBox ID="stdid" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label1" runat="server" Text="Label">Student First Name</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="stdfname" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
             </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label6" runat="server" Text="Label">Student Middle Name</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="stdmname" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
             </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label7" runat="server" Text="Label">Student Last Name</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="stdlname" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
             </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label3" runat="server" Text="Label">Student Email</asp:Label>
                </div>
                <div class="col-6">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label5" runat="server" Text="Label">Fees Balance</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="fbal" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label4" runat="server" Text="Label">Number of Students</asp:Label>
                </div>
                <div class="col-6">
            ...
            <div class="row m-auto pb-5" style="border-bottom: 1px solid #808080;">
                <div class="col">
                    <h3 style="text-align:center;margin:10px auto;">Student Information Table</h3>
