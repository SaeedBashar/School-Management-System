<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminViewTutorView.aspx.vb" Inherits="WORK.AdminViewTutorView" %>
        ...
        <div class="container">
            <div class="row" style="border-bottom:1px solid #808080">
             ...
             <div class="row form-group p-3">
                ...
                <div class="col-6">
                    <asp:TextBox ID="tuid" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label1" runat="server" Text="Label">Tutor First Name</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="tufname" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
             </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label6" runat="server" Text="Label">Tutor Middle Name</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="tumname" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
             </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label7" runat="server" Text="Label">Tutor Last Name</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="tulname" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
             </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label3" runat="server" Text="Label">Tutor Email</asp:Label>
                </div>
                <div class="col-6">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label5" runat="server" Text="Label">Phone</asp:Label>
                </div>
                <div class="col-6">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label4" runat="server" Text="Label">Number of Tutor</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="numtu" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row m-auto pb-5" style="border-bottom: 1px solid #808080;">
                <div class="col">
                    <h3 style="text-align:center;margin:10px auto;">Tutor Information Table</h3>
