<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminViewProgramView.aspx.vb" Inherits="WORK.AdminViewProgramView" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label1" runat="server" Text="Label">Program Id</asp:Label>
                </div>
                <div class="col-6">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label3" runat="server" Text="Label">Head Of Department Id</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="hdid" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label4" runat="server" Text="Label">Number of Programs</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="numd" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row m-auto pb-5" style="border-bottom: 1px solid #808080;">
                <div class="col">
                    <h3 style="text-align:center;margin:10px auto;">Program Information Table</h3>
