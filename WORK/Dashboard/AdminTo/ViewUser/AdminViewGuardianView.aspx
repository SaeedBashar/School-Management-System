<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminViewGuardianView.aspx.vb" Inherits="WORK.AdminViewGuardianView" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label1" runat="server" Text="Label">Guardian Name</asp:Label>
                </div>
                <div class="col-6">
            ...
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label2" runat="server" Text="Label">Guardian Phone</asp:Label>
                </div>
                <div class="col-6">
                    <asp:TextBox ID="gphone" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group p-3">
                <div class="col-6">
                    <asp:Label ID="Label3" runat="server" Text="Label">Guardian Ward</asp:Label>
                </div>
                <div class="col-6">
